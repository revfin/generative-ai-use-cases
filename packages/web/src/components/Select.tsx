...
type Props = RowItemProps & {
  ...
  clearable?: boolean;
  fullWidth?: boolean;
  // Borderless, icon-level control (used inside the chat composer)
  quiet?: boolean;
      ...
      <Listbox value={props.value} onChange={props.onChange}>
        <div className="relative">
          <Listbox.Button
            ...
            <span
              className={`pointer-events-none absolute inset-y-0 right-0 flex items-center ${props.quiet ? 'pr-1 text-[#969696]' : 'pr-2'}`}>
              ...
              <Listbox.Option
                ...
                {({ selected }) => (
                  <>
                    ...
                    {selected ? (
                      <span className="text-aws-squid-ink absolute inset-y-0 left-0 flex items-center pl-3">
